  ...
  return (
    <>
      <section className="AmountPage d-flex flex-column mb-3 justify-content-start align-items-center">
        ...
        <form onSubmit={submit} className="AmountForm d-flex flex-column my-3 justify-content-start p-5 w-50">
          <h3>Inserir Estoque</h3>
          <div className="formContent d-flex flex-column justify-content-center align-items-center">
            <div className="formSelect w-100">
              <Form.Select
                size="lg"
                name="product"
                id="product"
            ...
            <div className="form_submit w-100 d-flex justify-content-start">
              <Form.Control
                id="qtd"
